...
if(EXISTS ${BOARD_DEFCONFIG})
	...
	if(SERIAL_UWB1)
		list(APPEND board_serial_ports UWB1:${SERIAL_UWB1})
	endif()
	if(SERIAL_UWB2)
		list(APPEND board_serial_ports UWB2:${SERIAL_UWB2})
	endif()
	if(SERIAL_UWB3)
		list(APPEND board_serial_ports UWB3:${SERIAL_UWB3})
	endif()
	if(SERIAL_UWB4)
		list(APPEND board_serial_ports UWB4:${SERIAL_UWB4})
	endif()
	if(SERIAL_SRV1)
		list(APPEND board_serial_ports SRV1:${SERIAL_SRV1})
	endif()
	if(SERIAL_SRV2)
